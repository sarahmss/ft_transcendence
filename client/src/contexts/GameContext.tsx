  ...
  useEffect(() => {
    socket.on('connect', () => {
		...
		if (storedPlayer !== null) {
			socket.emit('reconnect', JSON.parse(storedPlayer));
		}
	...
	socket.on('PlayersRefresh', (players) => {
		...
		if (player)
		{
			localStorage.setItem('player', JSON.stringify(player)); // usar o jwt em vez de 'player' como chave pra resgatar as infos de jogo do usuario no localStorage 
